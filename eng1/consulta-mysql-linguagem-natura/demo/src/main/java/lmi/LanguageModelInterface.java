...
public class LanguageModelInterface {
    ...
    private static void initializeLists() {
        System.out.println("Teste: antes de pegar os modelos do Ollama");
        List<String> originalOllamaList = CMDCommandExecutor.getOllamaLmsNames();
        System.out.println("Teste: depois de pegar os modelos do Ollama");
        List<String> originalLMStudioList = CMDCommandExecutor.getLMStudioLmsNames();
        System.out.println("Teste: depois de pegar os modelos do LM Studio");
